@extends('layouts.app', ['class' => 'off-canvas-sidebar', 'activePage' => 'new_aluno', 'titlePage' => __('')])
      ...
      <form class="form" method="POST"  enctype="multipart/form-data" action="{{ route('aluno.store') }}">
        ...
        <div class="card card-login card-hidden mb-3">
          <div class="card-header card-header-primary text-center">
            <h4 class="card-title"><strong>{{ __('Registrar novo aluno') }}</strong></h4>
          ...
          <div class="card-body ">
            ...
            <div class="bmd-form-group{{ $errors->has('codigo') ? ' has-danger' : '' }} mt-3">
              <div class="input-group">
                ...
                <input type="number" name="codigo" class="form-control" placeholder="{{ __('Codigo do aluno(matrícula)...') }}" value="{{ old('codigo') }}" required>
              </div>
        ...
        <a href="javascript:;" class="btn btn-danger btn-round fileinput-exists" data-dismiss="fileinput"><i class="fa fa-times"></i> Remove</a>
            ...
            <div class="bmd-form-group{{ $errors->has('cep') ? ' has-danger' : '' }}">
              <div class="input-group">
                ...
                <input type="number" name="cep" id="cep" class="form-control" placeholder="{{ __('Somente números...') }}" value="{{ old('cep') }}" required>
              </div>
              @if ($errors->has('cep'))
            ...
            <div class="bmd-form-group{{ $errors->has('logradouro') ? ' has-danger' : '' }}">
              <div class="input-group">
                ...
                <input type="text" id="logradouro" name="logradouro" class="form-control" placeholder="{{ __('Logradouro...') }}" value="{{ old('logradouro') }}" required>
              </div>
            ...
            <div class="bmd-form-group{{ $errors->has('cidade') ? ' has-danger' : '' }}">
              <div class="input-group">
                ...
                <input type="text" id="cidade" name="cidade" class="form-control" placeholder="{{ __('Cidade...') }}" value="{{ old('cidade') }}" required>
              </div>
            ...
            <div class="bmd-form-group{{ $errors->has('estado') ? ' has-danger' : '' }}">
              <div class="input-group">
                ...
                <input type="text" id="estado" name="estado" class="form-control" placeholder="{{ __('Estado...') }}" value="{{ old('estado') }}" required>
              </div>
            ...
            <div class="bmd-form-group{{ $errors->has('bairro') ? ' has-danger' : '' }}">
              <div class="input-group">
                ...
                <input type="text" id="bairro" name="bairro" class="form-control" placeholder="{{ __('Bairro...') }}" value="{{ old('bairro') }}" required>
              </div>
            ...
            <div class="bmd-form-group{{ $errors->has('numero') ? ' has-danger' : '' }}">
              <div class="input-group">
                ...
                <input type="text" id="numero" name="numero" class="form-control" placeholder="{{ __('Número...') }}" value="{{ old('numero') }}" required>
              </div>
            ...
            <div class="bmd-form-group{{ $errors->has('complemento') ? ' has-danger' : '' }}">
              <div class="input-group">
                ...
                <input type="text" id="complemento" name="complemento" class="form-control" placeholder="{{ __('Complemento...') }}" value="{{ old('complemento') }}" required>
              </div>
          ...
          <div class="card-footer justify-content-center">
            <button type="submit" class="btn btn-primary btn-link btn-lg">{{ __('Cadastrar aluno') }}</button>
          </div>
        </div>
